...
INSERT INTO `game` VALUES (4,'','ciao belloooooooooooo3','bellaaaaaaiiiiiiiiiiiiiiia3',1,1);
...
CREATE TABLE `poi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `indizio` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `FKeabfj8n0hscg0uruflkacawre` FOREIGN KEY (`id`) REFERENCES `rel_game_poi` (`id`),
...
CREATE TABLE `team` (
  ...
  `nome` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FKrn2uq3scarorwycsmi911290p` FOREIGN KEY (`id`) REFERENCES `rel_team_game` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,1,'vale1',1,'vale'),(2,1,'vale0',0,'vale'),(3,1,'vale2',2,'vale');
...
-- Dump completed on 2019-02-04 16:01:14
